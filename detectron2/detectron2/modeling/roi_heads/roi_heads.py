...
class StandardROIHeads(ROIHeads):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        vision_width = 2048  # cfg.MODEL.RESNETS.STEM_OUT_CHANNELS
        output_dim = 1024
        self.attnpool = AttentionPool2d(image_resolution // 32, embed_dim, vision_width // 64, output_dim)
    ...
    def from_config(cls, cfg, input_shape):
        ...
        sam = None
        if cfg.MODEL.BBOX_REFINE.ENABLE:
            from segment_anything import sam_model_registry, SamPredictor
            from detectron2.utils.sam_predictor_with_buffer import SamPredictorBuffer
            sam_checkpoint = cfg.MODEL.BBOX_REFINE.MODEL_CHECKPOINT
            model_type = cfg.MODEL.BBOX_REFINE.MODEL_TYPE
