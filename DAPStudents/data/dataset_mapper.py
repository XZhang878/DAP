...
from coStudents.data.detection_utils import build_strong_augmentation
...
class DatasetMapperTwoCropSeparate(DatasetMapper):
    ...
    def __call__(self, dataset_dict):
        ...
        image_root = dataset_dict["file_name"]
        image_name1 = image_root.split('.')
        image_root_new = image_name1[0] + ".jpg"
        image = utils.read_image(image_root_new, format=self.img_format)
